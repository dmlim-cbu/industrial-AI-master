...
- `2020-10` [어프렌티스 프로젝트](https://github.com/dmlim-cb/industrial-AI/tree/master/projects/어프렌티스-프로젝트): 문제해결방법론 교육 및 프로젝트 준비
...
- `2020-10` [지능로봇 실제](https://github.com/dmlim-cb/industrial-AI/tree/master/projects/지능로봇-실제): 로봇 운영체제 ROS를 중심으로 지능형 로봇 설계 및 운영 실습
